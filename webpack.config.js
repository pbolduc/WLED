...
const wled = {"state":{"on":false,"bri":96,"transition":7,"ps":-1,"pss":44545,"pl":-1,"ccnf":{"min":1,"max":5,"time":12},"nl":{"on":false,"dur":60,"fade":true,"mode":1,"tbri":0},"udpn":{"send":false,"recv":true},"lor":0,"mainseg":0,"seg":[{"id":0,"start":0,"stop":150,"len":150,"grp":1,"spc":0,"on":true,"bri":255,"col":[[255,160,0],[0,0,0],[0,0,0]],"fx":0,"sx":128,"ix":128,"pal":0,"sel":true,"rev":false,"mi":false}]},"info":{"ver":"0.10.2","vid":2009030,"leds":{"count":150,"rgbw":false,"wv":false,"pin":[2],"pwr":250,"maxpwr":850,"maxseg":10,"seglock":false},"str":false,"name":"WLED","udpport":21324,"live":false,"lm":"","lip":"","ws":0,"fxcount":113,"palcount":52,"wifi":{"bssid":"0E:EC:DA:F1:10:9C","rssi":-60,"signal":80,"channel":11},"arch":"esp8266","core":"2_7_4","lwip":1,"freeheap":16632,"uptime":40,"u":{"Temperature":[26,"°C"]},"opt":119,"brand":"WLED","product":"FOSS","mac":"483fda6c89e4"},"effects":[
...
module.exports = {
    ...
    devServer: {
        ...
        before: function (app, server, compiler) {
            ...
            app.post('/json/si', function (req, res) {
                wled.state.on = req.body.on;
                wled.state.transition = req.body.transition;
                res.json(wled);
            });
            ...
            app.get('/json/live', function (req, res) {
                live.count = live.count + 1;
                if (live.count % 10 === 0) {
                    live.index = live.index + 1;
                    if (live.leds.length === live.index) {
                        live.index = 0;
                    }
                    live.count = 0;
                }

                res.json(live.leds[live.index]);
            });
